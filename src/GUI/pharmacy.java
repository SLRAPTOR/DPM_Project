...
import Module.prscripITModModel;
...
Connection conn;
    private prscripITModModel prscripITModModel;
    ...
    public pharmacy() {
        ...
        prscripITModModel = new prscripITModModel();
   ...
   String query1 = "SELECT * FROM `inwardpatients`";
   ...
   String query1 = "SELECT * FROM `prescription_item`";
        ...
        try {
            ...
            while (rs1.next()) {
                String id = rs1.getString("idpharmacy");
                jComboBox1.addItem(id);
            }
