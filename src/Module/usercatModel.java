...
public class usercatModel {
    ...
    public usercatModel() {
     ...
     public void loadTable(String keyword, int categoryId, DefaultTableModel wardTableModel) {
        ...
        String runningQuery = "SELECT * FROM user_cat WHERE iduser_cat like ? ";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String id_User = rs.getString("iduser_cat");
    ...
    public String upwm(String nic,String name) {
        ...
        String query = "UPDATE dpmdb.user_cat SET     catname=? WHERE (iduser_cat=?)";
